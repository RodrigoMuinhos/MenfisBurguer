...
values (
  'monte-sua-caixinha',
  'Monte sua Caixinha',
  'Caixinha Sweet com 4 doces a escolha. Brigadeiro, beijinho, cajuzinho, casadinho e doces premium com acrescimo.',
  8.90,
  true,
  '/sweet.jpg',
  now()
...
values (
  ...
  0.35,
  true,
  'Caixinha com 4 doces basicos inclusos. Premium soma R$ 2,90 por unidade.',
  false,
  '/sweet.jpg',
  null,
  now()
