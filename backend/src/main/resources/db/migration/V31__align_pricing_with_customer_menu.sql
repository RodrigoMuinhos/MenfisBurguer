with menu(id, name, category, kind, sale_price, original_price, image_url, code) as (
  values
    ...
    ('extra-maionese-barbecue', 'Maionese Barbecue', 'Adicional', 'side', 2.00, null, '/EXTRAS/MaioneseBarbecue.jpg', 'MAIONESE-BBQ'),
...
with menu(id, name, sale_price, image_url) as (
  values
    ...
    ('extra-maionese-barbecue', 'Maionese Barbecue', 2.00, '/EXTRAS/MaioneseBarbecue.jpg'),
