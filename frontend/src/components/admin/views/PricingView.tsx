...
const DEFAULT_ROWS: PricingRow[] = [
  ...
  drink("guarana-zero", "GUARANA", "Guarana Zero", 2.89, 9.9),
  drink("guarana", "GUARANA-TRADICIONAL", "Guaraná", 2.89, 9.9),
  ...
  side("smash-nutella-marshmallow", "MENFIS-NUTELLA", "Menfi's Nutella", 0, 23.9, "Sweet"),
  side("menfis-doce-de-leite", "MENFIS-DOCE-LEITE", "Menfi's Doce de Leite", 7.2, 23.9, "Sweet"),
